function ribbon_return(primaryControl) {
    ...
    formParameters["crc6f_date"] = formContext.getAttribute("crc6f_reserved_handover").getValue();
    formParameters["crc6f_type"] = 1;
    ...
    Xrm.Navigation.openForm(entityFormOptions, formParameters).then(
        function (success) {
            ...
            formContext.getAttribute("crc6f_return_report").setValue(lookupValue);

            //actual pickup 
            formContext.getAttribute("crc6f_actual_return").setValue(new Date());
        },
        function (error) {
            console.log(error);
        });
